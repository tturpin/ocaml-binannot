...
=>
let (_ : unit -> 'a) = function Error: File "completion/completion.ml", line 124, characters 19-25: Assertion failed
Called from file "main/ocamlwizard.ml", line 90, characters 14-32
Called from file "main/ocamlwizard.ml", line 61, characters 6-10
EOF
...
let () = match () with | $
=>
let () = match () with | Error: File "completion/completion.ml", line 124, characters 19-25: Assertion failed
Called from file "main/ocamlwizard.ml", line 90, characters 14-32
Called from file "main/ocamlwizard.ml", line 61, characters 6-10
EOF
...
let () = match true with true -> () | $
=>
let () = match true with true -> () | Error: File "completion/completion.ml", line 124, characters 19-25: Assertion failed
Called from file "main/ocamlwizard.ml", line 90, characters 14-32
Called from file "main/ocamlwizard.ml", line 61, characters 6-10
EOF
